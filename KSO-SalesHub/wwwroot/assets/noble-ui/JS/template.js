...
(function ($) {
    ...
    $(function () {
        ...
        // For Buy Now button. 
        $("body").prepend('\
      <div class="buy-now-wrapper hide">\
    ...
    ');
        ...
        function isActive(href) {
            var normalizedHref = href.replace(/^\/|\/$/g, ''); // Normalize href
            return currentPath === normalizedHref;
        }

        var currentPath = location.pathname.replace(/^\/|\/$/g, ''); // Normalize current path
        ...
        $('.nav li a', sidebar).each(function () {
            var $this = $(this);
            var href = $this.attr('href').replace(/^\/|\/$/g, ''); // Normalize href

            //console.log(currentPath);
            //console.log(href);
            if (isActive(href)) {
                $this.addClass('active');
                $this.parents('.nav-item').addClass('active'); // Add active to parent nav items
                if ($this.closest('.collapse').length) {
                    $this.closest('.collapse').addClass('show'); // Show collapsible items
                }
            }
        });
        // end custom
