$(function() {
  ...
  var revenueChartCategories = [
    ...
    if ($('#PieRuId').length) {
        ...
        let LbSeries = $('#PieRuId').data("series").split(",");
        let LbValue = $('#PieRuId').data("percentage");
...
if($('#apexChart3').length){
    ...
    new ApexCharts(document.querySelector("#apexChart3"),options1).render();
}
...
if($('#apexChart5').length){
    ...
    new ApexCharts(document.querySelector("#apexChart5"),options1).render();
}
  ...
  // Revenue Chart - RTL - END
    ...
    if ($('#monthlyChartRuId').length) {
        ...
        var apexBarChart = new ApexCharts(document.querySelector("#monthlyChartRuId"), options);
        apexBarChart.render();
    };
